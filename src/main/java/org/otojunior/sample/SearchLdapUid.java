 ...
 * @author [Author name]
 */
public class SearchLdapUid {
	/**
	 * SLF4J Logger.
	 */
	private static final Logger LOG = LoggerFactory.getLogger(SearchLdapUid.class);
